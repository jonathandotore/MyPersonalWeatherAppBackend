...
public sealed class CredenciaisInvalidasException()
    : DomainException("E-mail ou senha inválidos.")
{
    public override string Titulo => "Credenciais inválidas";
}

/// <summary>E-mail já usado por outro usuário registrado. Vira HTTP 409.</summary>
public sealed class EmailJaCadastradoException(string email)
    : DomainException($"O e-mail '{email}' já está cadastrado.")
{
