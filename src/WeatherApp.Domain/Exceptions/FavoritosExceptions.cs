...
/// </summary>
public sealed class FavoritoDuplicadoException(string cidade) : DomainException($"A cidade '{cidade}' já está nos seus favoritos.")
{
...
/// </summary>
public sealed class FavoritoNaoEncontradoException(Guid id) : DomainException($"Favorito '{id}' não encontrado.")
{
...
/// </summary>
public sealed class UsuarioNaoIdentificadoException() : DomainException($"Não foi possível identificar o usuário. Envie um GUID válido no header 'X-Usuario-Id' ou autentique-se para obter um token.")
{
